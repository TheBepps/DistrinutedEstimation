function plotTriangle2d_V2(x, y, theta,colour)

    % Define the vertices of the triangle
    triangle_vertices = [1, 0; -1, 1; -1, -1; 1, 0]*0.9;
    ...
    % Plot the triangle
    fill(translated_triangle(:,1), translated_triangle(:,2), colour); % Filled triangle
end